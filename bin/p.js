...
Main.prototype = {
	...
	,selectUserMedia: function(id) {
		var opt = { video : { optional : [{ sourceId : id},{ aspectRatio : window.screen.availWidth / window.screen.availHeight}], mandatory : { minWidth : window.screen.availWidth / 2, minHeight : window.screen.availHeight / 2}}};
	...
	,onUserMedia: function(stream) {
		haxe_Log.trace("got stream",{ fileName : "Main.hx", lineNumber : 119, className : "Main", methodName : "onUserMedia", customParams : [stream]});
		var streamURL = window.URL.createObjectURL(stream);
		haxe_Log.trace("stream url",{ fileName : "Main.hx", lineNumber : 121, className : "Main", methodName : "onUserMedia", customParams : [streamURL]});
